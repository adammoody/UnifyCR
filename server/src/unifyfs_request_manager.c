 ...
 * file size */
static int truncate_delete_keys(size_t filesize, int num, unifyfs_keyval_t* keyvals)
{
...
static int truncate_rewrite_keys(size_t filesize, int num, unifyfs_keyval_t* keyvals)
{
    /* assume we'll succeed */
    int ret = (int) UNIFYFS_SUCCESS;
